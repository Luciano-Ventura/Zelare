...
import { ArrowRight, Clock, Users, UserSquare2, CalendarClock, AlertTriangle, UserCheck, SearchX } from "lucide-react";
...
export default async function AdminDashboard() {
  ...
  const [
    ...
    supabaseAdmin.from("profissionais_cadastros").select("*", { count: "exact", head: true }).eq("status", "Em análise"),
  ...
  const filaAcao = [
    ...
    { name: "Profs p/ Validar", value: countProfAnalise || 0, icon: UserSquare2, href: "/admin/profissionais?status=Em análise", color: "text-yellow-800", bg: "bg-yellow-100", border: "border-yellow-200" },
              ...
              return (
                <div key={i} className="flex flex-col items-center gap-2 flex-1 group">
                  <div className="w-full relative flex justify-center h-full items-end">
                    <div 
                      className="w-full max-w-[32px] bg-[#8ECADF] rounded-t-md transition-all duration-300 group-hover:bg-[#6bb6ce]"
